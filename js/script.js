var slist = {
    ...
    init : () => {
      ...
      slist.hform = document.getElementById("pl-form");
      slist.hitem = document.getElementById("pl-item");
      slist.hadd = document.getElementById("pl-add");
      slist.hlist = document.getElementById("pl-list");
